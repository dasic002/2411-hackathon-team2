...
We created a specific testing template to ensure and re-check all aspects of the app were working correctly as specified with expected and actual outcomes using a methodical approach. We did final testing on the deployed site.

We tested the page for the following aspects:
...
A summary of the main steps of the testing procedure is documented here : [TESTING](TESTING.md)
